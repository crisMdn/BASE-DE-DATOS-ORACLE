--------------------------------------------------------
-- Archivo creado  - martes-junio-10-2025   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."CLIENTES" TO "C##CRIS";
  GRANT DELETE ON "SYSTEM"."CLIENTES" TO "C##CRIS";
  GRANT INSERT ON "SYSTEM"."CLIENTES" TO "C##CRIS";
  GRANT UPDATE ON "SYSTEM"."CLIENTES" TO "C##CRIS";
  GRANT DELETE ON "SYSTEM"."CLIENTES" TO "C##ROL_GESTION_HOTEL";
  GRANT INSERT ON "SYSTEM"."CLIENTES" TO "C##ROL_GESTION_HOTEL";
  GRANT SELECT ON "SYSTEM"."CLIENTES" TO "C##ROL_GESTION_HOTEL";
  GRANT UPDATE ON "SYSTEM"."CLIENTES" TO "C##ROL_GESTION_HOTEL";
--------------------------------------------------------
--  DDL for Table HABITACIONES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."HABITACIONES" 
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."HABITACIONES" TO "C##CRIS";
  GRANT DELETE ON "SYSTEM"."HABITACIONES" TO "C##CRIS";
  GRANT INSERT ON "SYSTEM"."HABITACIONES" TO "C##CRIS";
  GRANT UPDATE ON "SYSTEM"."HABITACIONES" TO "C##CRIS";
  GRANT DELETE ON "SYSTEM"."HABITACIONES" TO "C##ROL_GESTION_HOTEL";
  GRANT INSERT ON "SYSTEM"."HABITACIONES" TO "C##ROL_GESTION_HOTEL";
  GRANT SELECT ON "SYSTEM"."HABITACIONES" TO "C##ROL_GESTION_HOTEL";
  GRANT UPDATE ON "SYSTEM"."HABITACIONES" TO "C##ROL_GESTION_HOTEL";
--------------------------------------------------------
--  DDL for Table HELP
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."PAGOS" TO "C##CRIS";
  GRANT DELETE ON "SYSTEM"."PAGOS" TO "C##CRIS";
  GRANT INSERT ON "SYSTEM"."PAGOS" TO "C##CRIS";
  GRANT UPDATE ON "SYSTEM"."PAGOS" TO "C##CRIS";
  GRANT DELETE ON "SYSTEM"."PAGOS" TO "C##ROL_GESTION_HOTEL";
  GRANT INSERT ON "SYSTEM"."PAGOS" TO "C##ROL_GESTION_HOTEL";
  GRANT SELECT ON "SYSTEM"."PAGOS" TO "C##ROL_GESTION_HOTEL";
  GRANT UPDATE ON "SYSTEM"."PAGOS" TO "C##ROL_GESTION_HOTEL";
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."RESERVAS" TO "C##CRIS";
  GRANT DELETE ON "SYSTEM"."RESERVAS" TO "C##CRIS";
  GRANT INSERT ON "SYSTEM"."RESERVAS" TO "C##CRIS";
  GRANT UPDATE ON "SYSTEM"."RESERVAS" TO "C##CRIS";
  GRANT DELETE ON "SYSTEM"."RESERVAS" TO "C##ROL_GESTION_HOTEL";
  GRANT INSERT ON "SYSTEM"."RESERVAS" TO "C##ROL_GESTION_HOTEL";
  GRANT SELECT ON "SYSTEM"."RESERVAS" TO "C##ROL_GESTION_HOTEL";
  GRANT UPDATE ON "SYSTEM"."RESERVAS" TO "C##ROL_GESTION_HOTEL";
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for View VISTA_RESERVAS_DETALLE
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."VISTA_RESERVAS_DETALLE" ("NUM_RESERVA", "NOMBRE_CLIENTE", "NUM_HABITACION", "FECHA_ENTRADA", "FECHA_SALIDA") AS 
  SELECT 
    R.num_reserva,
...
;
--------------------------------------------------------
--  DDL for View VISTA_RESERVAS_PROXIMAS
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."VISTA_RESERVAS_PROXIMAS" ("NUM_RESERVA", "DUI_CLIENTE", "FECHA_ENTRADA", "FECHA_SALIDA") AS 
  SELECT 
    num_reserva,
    dui_cliente,
    fecha_entrada,
...
;
--------------------------------------------------------
--  DDL for View VISTA_RESUMEN_PAGOS
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."VISTA_RESUMEN_PAGOS" ("TIPO_PAGO", "CANTIDAD_PAGOS", "TOTAL_PAGADO") AS 
  SELECT 
    tipo_pago,
...
SET DEFINE OFF;
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('1234567890','Luis Toledo','7777-6969');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('1122334455','Carlos López','7888-0000');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('06375632-7','CHRISTOPHER','2232-5543');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('01112233-4','Diana García','7654-3210');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('02223344-5','Marco Pérez','7123-4567');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('05678976-9','Antonio','6765-0090');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('9999999-0','Ejemplo Prueba','7000-0000');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('55298187-2','Cliente4','2213-5028');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('48015130-1','Cliente5','2248-7274');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('66039357-2','Cliente6','2289-1700');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('26723929-1','Cliente7','2224-3551');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('91170740-3','Cliente8','2230-6839');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('72790323-5','Cliente9','2282-7361');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('87593471-1','Cliente10','2279-4112');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('75613865-6','Cliente11','2272-2707');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('50002807-6','Cliente12','2248-8082');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('24329263-6','Cliente13','2213-1033');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('83407661-3','Cliente14','2265-6372');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('76539038-3','Cliente15','2213-6732');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('66840781-4','Cliente16','2238-7051');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('61301699-7','Cliente17','2231-1376');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('18620770-2','Cliente18','2287-4333');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('76157607-0','Cliente19','2222-1763');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('39375357-3','Cliente20','2287-3812');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('65416804-2','Cliente21','2236-8681');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('42384292-8','Cliente22','2298-6332');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('19960532-6','Cliente23','2267-4745');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('41244539-4','Cliente24','2245-7905');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('41873897-0','Cliente25','2278-5109');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('46523262-3','Cliente26','2246-2964');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('72481053-1','Cliente27','2217-7085');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('12381880-9','Cliente28','2224-7248');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('59142315-3','Cliente29','2258-4116');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('24887163-9','Cliente30','2281-1802');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('99146995-7','Cliente31','2221-9885');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('76714303-5','Cliente32','2262-8111');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('40616496-6','Cliente33','2250-7206');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('80740558-0','Cliente34','2272-2792');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('81848630-2','Cliente35','2293-8463');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('12480629-7','Cliente36','2295-6014');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('80028113-4','Cliente37','2289-2898');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('96698197-1','Cliente38','2229-2737');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('95944320-4','Cliente39','2283-9045');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('30641940-9','Cliente40','2256-8018');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('69821973-8','Cliente41','2253-8606');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('46005159-4','Cliente42','2244-6913');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('95022083-2','Cliente43','2270-7561');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('73352650-0','Cliente44','2293-7818');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('90054524-4','Cliente45','2298-3358');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('38471749-4','Cliente46','2289-8178');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('13254351-9','Cliente47','2220-4124');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('42825484-8','Cliente48','2271-3002');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('68475160-2','Cliente49','2271-9606');
Insert into SYSTEM.CLIENTES (DUI,NOMBRE,TELEFONO) values ('86495151-9','Cliente50','2227-9067');
REM INSERTING into SYSTEM.HABITACIONES
SET DEFINE OFF;
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (101,'Individual',45);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (103,'Suite',120);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (12,'Individual',50);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (15,'Doble',90);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (20,'Suite',150);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (11,'Individual',100);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (14,'Doble',90);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (17,'Doble',90);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (16,'Individual',60);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (104,'Doble',110);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (105,'Individual',80);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (106,'Doble',110);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (107,'Individual',50);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (108,'Doble',130);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (109,'Individual',50);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (110,'Doble',90);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (111,'Individual',80);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (112,'Individual',120);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (113,'Doble',110);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (114,'Doble',60);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (115,'Doble',110);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (116,'Suite',80);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (117,'Individual',50);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (118,'Individual',120);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (119,'Doble',90);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (120,'Suite',100);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (121,'Doble',130);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (122,'Suite',50);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (123,'Individual',80);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (124,'Doble',130);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (125,'Suite',80);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (126,'Doble',130);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (127,'Doble',60);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (128,'Individual',80);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (129,'Suite',100);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (130,'Suite',80);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (131,'Doble',60);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (132,'Individual',120);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (133,'Individual',120);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (134,'Doble',60);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (135,'Suite',80);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (136,'Individual',120);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (137,'Suite',50);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (138,'Individual',100);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (139,'Individual',80);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (140,'Doble',130);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (141,'Suite',120);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (142,'Individual',50);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (143,'Suite',50);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (144,'Individual',50);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (145,'Individual',50);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (146,'Individual',120);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (147,'Individual',80);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (148,'Suite',100);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (149,'Doble',60);
Insert into SYSTEM.HABITACIONES (NUM_HABITACION,TIPO,PRECIO) values (150,'Doble',110);
...
SET DEFINE OFF;
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (1,1,to_date('01/06/25','DD/MM/RR'),'Efectivo',180);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (4,3,to_date('01/06/25','DD/MM/RR'),'Efectivo',180);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (20,10,to_date('03/06/25','DD/MM/RR'),'Efectivo',100);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (21,11,to_date('11/07/25','DD/MM/RR'),'Tarjeta',160);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (22,12,to_date('19/08/25','DD/MM/RR'),'Transferencia',450);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (9,30,to_date('04/06/25','DD/MM/RR'),'Efectivo',120);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (80,40,to_date('26/06/25','DD/MM/RR'),'Transferencia',78.94);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (100,50,to_date('03/06/25','DD/MM/RR'),'Efectivo',120.95);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (120,60,to_date('20/06/25','DD/MM/RR'),'Transferencia',134.1);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (140,70,to_date('19/06/25','DD/MM/RR'),'Transferencia',158.84);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (160,80,to_date('01/06/25','DD/MM/RR'),'Transferencia',56.51);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (180,90,to_date('26/06/25','DD/MM/RR'),'Transferencia',76.77);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (200,100,to_date('29/06/25','DD/MM/RR'),'Transferencia',101.72);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (220,110,to_date('15/06/25','DD/MM/RR'),'Efectivo',138.34);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (240,120,to_date('18/06/25','DD/MM/RR'),'Efectivo',70.84);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (260,130,to_date('16/06/25','DD/MM/RR'),'Transferencia',180.98);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (280,140,to_date('15/06/25','DD/MM/RR'),'Transferencia',75.58);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (300,150,to_date('27/06/25','DD/MM/RR'),'Efectivo',144.07);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (320,160,to_date('21/06/25','DD/MM/RR'),'Efectivo',150.93);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (340,170,to_date('21/06/25','DD/MM/RR'),'Efectivo',65.09);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (360,180,to_date('10/06/25','DD/MM/RR'),'Transferencia',94.49);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (380,190,to_date('17/06/25','DD/MM/RR'),'Efectivo',51.89);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (400,200,to_date('20/06/25','DD/MM/RR'),'Transferencia',79.45);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (420,210,to_date('25/06/25','DD/MM/RR'),'Efectivo',96.74);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (440,220,to_date('17/06/25','DD/MM/RR'),'Transferencia',117.98);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (460,230,to_date('19/06/25','DD/MM/RR'),'Efectivo',77.15);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (480,240,to_date('18/06/25','DD/MM/RR'),'Transferencia',158.3);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (500,250,to_date('12/06/25','DD/MM/RR'),'Efectivo',116.74);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (520,260,to_date('07/06/25','DD/MM/RR'),'Transferencia',76.15);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (540,270,to_date('12/06/25','DD/MM/RR'),'Transferencia',134.53);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (560,280,to_date('11/06/25','DD/MM/RR'),'Transferencia',179.35);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (580,290,to_date('23/06/25','DD/MM/RR'),'Transferencia',192.74);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (600,300,to_date('19/06/25','DD/MM/RR'),'Transferencia',70.63);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (620,310,to_date('04/06/25','DD/MM/RR'),'Efectivo',53.53);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (640,320,to_date('09/06/25','DD/MM/RR'),'Transferencia',162.32);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (660,330,to_date('11/06/25','DD/MM/RR'),'Efectivo',145.27);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (680,340,to_date('03/06/25','DD/MM/RR'),'Transferencia',95.56);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (700,350,to_date('18/06/25','DD/MM/RR'),'Efectivo',79.24);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (720,360,to_date('05/06/25','DD/MM/RR'),'Transferencia',183.82);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (740,370,to_date('10/06/25','DD/MM/RR'),'Transferencia',59.1);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (760,380,to_date('05/06/25','DD/MM/RR'),'Transferencia',67.55);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (780,390,to_date('17/06/25','DD/MM/RR'),'Efectivo',193.68);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (800,400,to_date('07/06/25','DD/MM/RR'),'Transferencia',121.49);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (820,410,to_date('23/06/25','DD/MM/RR'),'Efectivo',141.16);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (840,420,to_date('27/06/25','DD/MM/RR'),'Efectivo',129.58);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (860,430,to_date('19/06/25','DD/MM/RR'),'Efectivo',128.81);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (880,440,to_date('21/06/25','DD/MM/RR'),'Transferencia',182.9);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (900,450,to_date('25/06/25','DD/MM/RR'),'Efectivo',147.37);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (920,460,to_date('15/06/25','DD/MM/RR'),'Transferencia',189.91);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (940,470,to_date('18/06/25','DD/MM/RR'),'Transferencia',174.69);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (960,480,to_date('16/06/25','DD/MM/RR'),'Efectivo',182.14);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (980,490,to_date('01/06/25','DD/MM/RR'),'Transferencia',195.34);
Insert into SYSTEM.PAGOS (ID_PAGO,NUM_RESERVA,FECHA,TIPO_PAGO,MONTO) values (1000,500,to_date('29/06/25','DD/MM/RR'),'Transferencia',194.3);
...
REM INSERTING into SYSTEM.RESERVAS
SET DEFINE OFF;
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (1,to_date('01/06/25','DD/MM/RR'),to_date('05/06/25','DD/MM/RR'),'1234567890',101);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (3,to_date('15/06/25','DD/MM/RR'),to_date('20/06/25','DD/MM/RR'),'1122334455',103);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (10,to_date('10/05/25','DD/MM/RR'),to_date('05/05/25','DD/MM/RR'),'06375632-7',12);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (11,to_date('10/07/25','DD/MM/RR'),to_date('05/07/25','DD/MM/RR'),'01112233-4',15);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (12,to_date('18/08/25','DD/MM/RR'),to_date('15/08/25','DD/MM/RR'),'02223344-5',20);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (9,to_date('15/06/25','DD/MM/RR'),to_date('10/06/25','DD/MM/RR'),'05678976-9',11);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (30,to_date('15/06/25','DD/MM/RR'),to_date('10/06/25','DD/MM/RR'),'05678976-9',11);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (20,to_date('15/06/25','DD/MM/RR'),to_date('10/06/25','DD/MM/RR'),'9999999-0',11);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (40,to_date('27/06/25','DD/MM/RR'),to_date('26/06/25','DD/MM/RR'),'55298187-2',104);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (50,to_date('04/06/25','DD/MM/RR'),to_date('30/05/25','DD/MM/RR'),'48015130-1',105);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (60,to_date('21/06/25','DD/MM/RR'),to_date('19/06/25','DD/MM/RR'),'66039357-2',106);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (70,to_date('20/06/25','DD/MM/RR'),to_date('18/06/25','DD/MM/RR'),'26723929-1',107);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (80,to_date('02/06/25','DD/MM/RR'),to_date('29/05/25','DD/MM/RR'),'91170740-3',108);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (90,to_date('27/06/25','DD/MM/RR'),to_date('26/06/25','DD/MM/RR'),'72790323-5',109);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (100,to_date('30/06/25','DD/MM/RR'),to_date('29/06/25','DD/MM/RR'),'87593471-1',110);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (110,to_date('16/06/25','DD/MM/RR'),to_date('13/06/25','DD/MM/RR'),'75613865-6',111);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (120,to_date('19/06/25','DD/MM/RR'),to_date('15/06/25','DD/MM/RR'),'50002807-6',112);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (130,to_date('17/06/25','DD/MM/RR'),to_date('14/06/25','DD/MM/RR'),'24329263-6',113);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (140,to_date('16/06/25','DD/MM/RR'),to_date('13/06/25','DD/MM/RR'),'83407661-3',114);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (150,to_date('28/06/25','DD/MM/RR'),to_date('25/06/25','DD/MM/RR'),'76539038-3',115);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (160,to_date('22/06/25','DD/MM/RR'),to_date('21/06/25','DD/MM/RR'),'66840781-4',116);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (170,to_date('22/06/25','DD/MM/RR'),to_date('17/06/25','DD/MM/RR'),'61301699-7',117);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (180,to_date('11/06/25','DD/MM/RR'),to_date('10/06/25','DD/MM/RR'),'18620770-2',118);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (190,to_date('18/06/25','DD/MM/RR'),to_date('16/06/25','DD/MM/RR'),'76157607-0',119);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (200,to_date('21/06/25','DD/MM/RR'),to_date('20/06/25','DD/MM/RR'),'39375357-3',120);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (210,to_date('26/06/25','DD/MM/RR'),to_date('24/06/25','DD/MM/RR'),'65416804-2',121);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (220,to_date('18/06/25','DD/MM/RR'),to_date('15/06/25','DD/MM/RR'),'42384292-8',122);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (230,to_date('20/06/25','DD/MM/RR'),to_date('16/06/25','DD/MM/RR'),'19960532-6',123);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (240,to_date('19/06/25','DD/MM/RR'),to_date('14/06/25','DD/MM/RR'),'41244539-4',124);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (250,to_date('13/06/25','DD/MM/RR'),to_date('12/06/25','DD/MM/RR'),'41873897-0',125);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (260,to_date('08/06/25','DD/MM/RR'),to_date('05/06/25','DD/MM/RR'),'46523262-3',126);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (270,to_date('13/06/25','DD/MM/RR'),to_date('08/06/25','DD/MM/RR'),'72481053-1',127);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (280,to_date('12/06/25','DD/MM/RR'),to_date('09/06/25','DD/MM/RR'),'12381880-9',128);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (290,to_date('24/06/25','DD/MM/RR'),to_date('22/06/25','DD/MM/RR'),'59142315-3',129);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (300,to_date('20/06/25','DD/MM/RR'),to_date('17/06/25','DD/MM/RR'),'24887163-9',130);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (310,to_date('05/06/25','DD/MM/RR'),to_date('03/06/25','DD/MM/RR'),'99146995-7',131);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (320,to_date('10/06/25','DD/MM/RR'),to_date('09/06/25','DD/MM/RR'),'76714303-5',132);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (330,to_date('12/06/25','DD/MM/RR'),to_date('08/06/25','DD/MM/RR'),'40616496-6',133);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (340,to_date('04/06/25','DD/MM/RR'),to_date('31/05/25','DD/MM/RR'),'80740558-0',134);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (350,to_date('19/06/25','DD/MM/RR'),to_date('15/06/25','DD/MM/RR'),'81848630-2',135);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (360,to_date('06/06/25','DD/MM/RR'),to_date('03/06/25','DD/MM/RR'),'12480629-7',136);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (370,to_date('11/06/25','DD/MM/RR'),to_date('07/06/25','DD/MM/RR'),'80028113-4',137);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (380,to_date('06/06/25','DD/MM/RR'),to_date('04/06/25','DD/MM/RR'),'96698197-1',138);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (390,to_date('18/06/25','DD/MM/RR'),to_date('13/06/25','DD/MM/RR'),'95944320-4',139);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (400,to_date('08/06/25','DD/MM/RR'),to_date('04/06/25','DD/MM/RR'),'30641940-9',140);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (410,to_date('24/06/25','DD/MM/RR'),to_date('23/06/25','DD/MM/RR'),'69821973-8',141);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (420,to_date('28/06/25','DD/MM/RR'),to_date('27/06/25','DD/MM/RR'),'46005159-4',142);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (430,to_date('20/06/25','DD/MM/RR'),to_date('16/06/25','DD/MM/RR'),'95022083-2',143);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (440,to_date('22/06/25','DD/MM/RR'),to_date('19/06/25','DD/MM/RR'),'73352650-0',144);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (450,to_date('26/06/25','DD/MM/RR'),to_date('23/06/25','DD/MM/RR'),'90054524-4',145);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (460,to_date('16/06/25','DD/MM/RR'),to_date('15/06/25','DD/MM/RR'),'38471749-4',146);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (470,to_date('19/06/25','DD/MM/RR'),to_date('14/06/25','DD/MM/RR'),'13254351-9',147);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (480,to_date('17/06/25','DD/MM/RR'),to_date('13/06/25','DD/MM/RR'),'42825484-8',148);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (490,to_date('02/06/25','DD/MM/RR'),to_date('31/05/25','DD/MM/RR'),'68475160-2',149);
Insert into SYSTEM.RESERVAS (NUM_RESERVA,FECHA_SALIDA,FECHA_ENTRADA,DUI_CLIENTE,NUM_HABITACION) values (500,to_date('30/06/25','DD/MM/RR'),to_date('27/06/25','DD/MM/RR'),'86495151-9',150);
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.VISTA_RESERVAS_DETALLE
SET DEFINE OFF;
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (1,'Luis Toledo',101,to_date('05/06/25','DD/MM/RR'),to_date('01/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (3,'Carlos López',103,to_date('20/06/25','DD/MM/RR'),to_date('15/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (10,'CHRISTOPHER',12,to_date('05/05/25','DD/MM/RR'),to_date('10/05/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (11,'Diana García',15,to_date('05/07/25','DD/MM/RR'),to_date('10/07/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (12,'Marco Pérez',20,to_date('15/08/25','DD/MM/RR'),to_date('18/08/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (9,'Antonio',11,to_date('10/06/25','DD/MM/RR'),to_date('15/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (30,'Antonio',11,to_date('10/06/25','DD/MM/RR'),to_date('15/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (20,'Ejemplo Prueba',11,to_date('10/06/25','DD/MM/RR'),to_date('15/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (40,'Cliente4',104,to_date('26/06/25','DD/MM/RR'),to_date('27/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (50,'Cliente5',105,to_date('30/05/25','DD/MM/RR'),to_date('04/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (60,'Cliente6',106,to_date('19/06/25','DD/MM/RR'),to_date('21/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (70,'Cliente7',107,to_date('18/06/25','DD/MM/RR'),to_date('20/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (80,'Cliente8',108,to_date('29/05/25','DD/MM/RR'),to_date('02/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (90,'Cliente9',109,to_date('26/06/25','DD/MM/RR'),to_date('27/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (100,'Cliente10',110,to_date('29/06/25','DD/MM/RR'),to_date('30/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (110,'Cliente11',111,to_date('13/06/25','DD/MM/RR'),to_date('16/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (120,'Cliente12',112,to_date('15/06/25','DD/MM/RR'),to_date('19/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (130,'Cliente13',113,to_date('14/06/25','DD/MM/RR'),to_date('17/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (140,'Cliente14',114,to_date('13/06/25','DD/MM/RR'),to_date('16/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (150,'Cliente15',115,to_date('25/06/25','DD/MM/RR'),to_date('28/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (160,'Cliente16',116,to_date('21/06/25','DD/MM/RR'),to_date('22/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (170,'Cliente17',117,to_date('17/06/25','DD/MM/RR'),to_date('22/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (180,'Cliente18',118,to_date('10/06/25','DD/MM/RR'),to_date('11/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (190,'Cliente19',119,to_date('16/06/25','DD/MM/RR'),to_date('18/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (200,'Cliente20',120,to_date('20/06/25','DD/MM/RR'),to_date('21/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (210,'Cliente21',121,to_date('24/06/25','DD/MM/RR'),to_date('26/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (220,'Cliente22',122,to_date('15/06/25','DD/MM/RR'),to_date('18/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (230,'Cliente23',123,to_date('16/06/25','DD/MM/RR'),to_date('20/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (240,'Cliente24',124,to_date('14/06/25','DD/MM/RR'),to_date('19/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (250,'Cliente25',125,to_date('12/06/25','DD/MM/RR'),to_date('13/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (260,'Cliente26',126,to_date('05/06/25','DD/MM/RR'),to_date('08/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (270,'Cliente27',127,to_date('08/06/25','DD/MM/RR'),to_date('13/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (280,'Cliente28',128,to_date('09/06/25','DD/MM/RR'),to_date('12/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (290,'Cliente29',129,to_date('22/06/25','DD/MM/RR'),to_date('24/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (300,'Cliente30',130,to_date('17/06/25','DD/MM/RR'),to_date('20/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (310,'Cliente31',131,to_date('03/06/25','DD/MM/RR'),to_date('05/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (320,'Cliente32',132,to_date('09/06/25','DD/MM/RR'),to_date('10/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (330,'Cliente33',133,to_date('08/06/25','DD/MM/RR'),to_date('12/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (340,'Cliente34',134,to_date('31/05/25','DD/MM/RR'),to_date('04/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (350,'Cliente35',135,to_date('15/06/25','DD/MM/RR'),to_date('19/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (360,'Cliente36',136,to_date('03/06/25','DD/MM/RR'),to_date('06/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (370,'Cliente37',137,to_date('07/06/25','DD/MM/RR'),to_date('11/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (380,'Cliente38',138,to_date('04/06/25','DD/MM/RR'),to_date('06/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (390,'Cliente39',139,to_date('13/06/25','DD/MM/RR'),to_date('18/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (400,'Cliente40',140,to_date('04/06/25','DD/MM/RR'),to_date('08/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (410,'Cliente41',141,to_date('23/06/25','DD/MM/RR'),to_date('24/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (420,'Cliente42',142,to_date('27/06/25','DD/MM/RR'),to_date('28/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (430,'Cliente43',143,to_date('16/06/25','DD/MM/RR'),to_date('20/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (440,'Cliente44',144,to_date('19/06/25','DD/MM/RR'),to_date('22/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (450,'Cliente45',145,to_date('23/06/25','DD/MM/RR'),to_date('26/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (460,'Cliente46',146,to_date('15/06/25','DD/MM/RR'),to_date('16/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (470,'Cliente47',147,to_date('14/06/25','DD/MM/RR'),to_date('19/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (480,'Cliente48',148,to_date('13/06/25','DD/MM/RR'),to_date('17/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (490,'Cliente49',149,to_date('31/05/25','DD/MM/RR'),to_date('02/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_DETALLE (NUM_RESERVA,NOMBRE_CLIENTE,NUM_HABITACION,FECHA_ENTRADA,FECHA_SALIDA) values (500,'Cliente50',150,to_date('27/06/25','DD/MM/RR'),to_date('30/06/25','DD/MM/RR'));
REM INSERTING into SYSTEM.VISTA_RESERVAS_PROXIMAS
SET DEFINE OFF;
Insert into SYSTEM.VISTA_RESERVAS_PROXIMAS (NUM_RESERVA,DUI_CLIENTE,FECHA_ENTRADA,FECHA_SALIDA) values (3,'1122334455',to_date('20/06/25','DD/MM/RR'),to_date('15/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_PROXIMAS (NUM_RESERVA,DUI_CLIENTE,FECHA_ENTRADA,FECHA_SALIDA) values (9,'05678976-9',to_date('10/06/25','DD/MM/RR'),to_date('15/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_PROXIMAS (NUM_RESERVA,DUI_CLIENTE,FECHA_ENTRADA,FECHA_SALIDA) values (30,'05678976-9',to_date('10/06/25','DD/MM/RR'),to_date('15/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_PROXIMAS (NUM_RESERVA,DUI_CLIENTE,FECHA_ENTRADA,FECHA_SALIDA) values (20,'9999999-0',to_date('10/06/25','DD/MM/RR'),to_date('15/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_PROXIMAS (NUM_RESERVA,DUI_CLIENTE,FECHA_ENTRADA,FECHA_SALIDA) values (110,'75613865-6',to_date('13/06/25','DD/MM/RR'),to_date('16/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_PROXIMAS (NUM_RESERVA,DUI_CLIENTE,FECHA_ENTRADA,FECHA_SALIDA) values (130,'24329263-6',to_date('14/06/25','DD/MM/RR'),to_date('17/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_PROXIMAS (NUM_RESERVA,DUI_CLIENTE,FECHA_ENTRADA,FECHA_SALIDA) values (140,'83407661-3',to_date('13/06/25','DD/MM/RR'),to_date('16/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_PROXIMAS (NUM_RESERVA,DUI_CLIENTE,FECHA_ENTRADA,FECHA_SALIDA) values (180,'18620770-2',to_date('10/06/25','DD/MM/RR'),to_date('11/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_PROXIMAS (NUM_RESERVA,DUI_CLIENTE,FECHA_ENTRADA,FECHA_SALIDA) values (250,'41873897-0',to_date('12/06/25','DD/MM/RR'),to_date('13/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_PROXIMAS (NUM_RESERVA,DUI_CLIENTE,FECHA_ENTRADA,FECHA_SALIDA) values (270,'72481053-1',to_date('08/06/25','DD/MM/RR'),to_date('13/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_PROXIMAS (NUM_RESERVA,DUI_CLIENTE,FECHA_ENTRADA,FECHA_SALIDA) values (280,'12381880-9',to_date('09/06/25','DD/MM/RR'),to_date('12/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_PROXIMAS (NUM_RESERVA,DUI_CLIENTE,FECHA_ENTRADA,FECHA_SALIDA) values (330,'40616496-6',to_date('08/06/25','DD/MM/RR'),to_date('12/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_PROXIMAS (NUM_RESERVA,DUI_CLIENTE,FECHA_ENTRADA,FECHA_SALIDA) values (370,'80028113-4',to_date('07/06/25','DD/MM/RR'),to_date('11/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_PROXIMAS (NUM_RESERVA,DUI_CLIENTE,FECHA_ENTRADA,FECHA_SALIDA) values (460,'38471749-4',to_date('15/06/25','DD/MM/RR'),to_date('16/06/25','DD/MM/RR'));
Insert into SYSTEM.VISTA_RESERVAS_PROXIMAS (NUM_RESERVA,DUI_CLIENTE,FECHA_ENTRADA,FECHA_SALIDA) values (480,'42825484-8',to_date('13/06/25','DD/MM/RR'),to_date('17/06/25','DD/MM/RR'));
REM INSERTING into SYSTEM.VISTA_RESUMEN_PAGOS
SET DEFINE OFF;
Insert into SYSTEM.VISTA_RESUMEN_PAGOS (TIPO_PAGO,CANTIDAD_PAGOS,TOTAL_PAGADO) values ('Efectivo',23,2813.52);
Insert into SYSTEM.VISTA_RESUMEN_PAGOS (TIPO_PAGO,CANTIDAD_PAGOS,TOTAL_PAGADO) values ('Tarjeta',1,160);
Insert into SYSTEM.VISTA_RESUMEN_PAGOS (TIPO_PAGO,CANTIDAD_PAGOS,TOTAL_PAGADO) values ('Transferencia',29,4044.04);
--------------------------------------------------------
--  DDL for Index AQ$_KEY_SHARD_MAP_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."AQ$_KEY_SHARD_MAP_PK" ON "SYSTEM"."AQ$_KEY_SHARD_MAP" ("QUEUE", "KEY") 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C002815" ON "SYSTEM"."AQ$_INTERNET_AGENTS" ("AGENT_NAME") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C005845" ON "SYSTEM"."LOGSTDBY$FLASHBACK_SCN" ("PRIMARY_SCN") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008314" ON "SYSTEM"."CLIENTES" ("DUI") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008315" ON "SYSTEM"."HABITACIONES" ("NUM_HABITACION") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008316" ON "SYSTEM"."RESERVAS" ("NUM_RESERVA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008319" ON "SYSTEM"."PAGOS" ("ID_PAGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_IL0000001474C00010$$" ON "SYSTEM"."LOGMNR_SPILL$" (
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_IL0000001478C00008$$" ON "SYSTEM"."LOGMNR_AGE_SPILL$" (
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 16384 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_IL0000001482C00011$$" ON "SYSTEM"."LOGMNR_RESTART_CKPT_TXINFO$" (
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 16384 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_IL0000001487C00009$$" ON "SYSTEM"."LOGMNR_RESTART_CKPT$" (
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 16384 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_IL0000001487C00012$$" ON "SYSTEM"."LOGMNR_RESTART_CKPT$" (
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 16384 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_IL0000008863C00021$$" ON "SYSTEM"."OL$HINTS" (;
--------------------------------------------------------
--  DDL for Index SYS_IL0000008987C00012$$
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SYS_IL0000008987C00012$$" ON "SYSTEM"."AQ$_QUEUES" (
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_IL0000014504C00008$$" ON "SYSTEM"."SCHEDULER_PROGRAM_ARGS_TBL" (
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_IL0000014507C00007$$" ON "SYSTEM"."SCHEDULER_JOB_ARGS_TBL" (
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_IL0000016974C00009$$" ON "SYSTEM"."LOGSTDBY$EVENTS" (
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 16384 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_IL0000016986C00003$$" ON "SYSTEM"."LOGSTDBY$PLSQL" (
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Trigger TRG_PAGO_AUTOMATICO
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."TRG_PAGO_AUTOMATICO" 
AFTER INSERT ON RESERVAS
FOR EACH ROW
BEGIN
    INSERT INTO PAGOS (id_pago, num_reserva, fecha, tipo_pago, monto)
    VALUES (PAGOS_SEQ.NEXTVAL, :NEW.num_reserva, SYSDATE, 'Inicial', 0);
END;
/
ALTER TRIGGER "SYSTEM"."TRG_PAGO_AUTOMATICO" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_VALIDAR_FECHAS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."TRG_VALIDAR_FECHAS" 
...
/
ALTER TRIGGER "SYSTEM"."TRG_VALIDAR_FECHAS" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_VALIDAR_FECHAS
--------------------------------------------------------
...
ALTER TRIGGER "SYSTEM"."TRG_PAGO_AUTOMATICO" ENABLE;
--------------------------------------------------------
--  DDL for Procedure ACTUALIZAR_PRECIO_HABITACION
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."ACTUALIZAR_PRECIO_HABITACION" (
    p_tipo IN VARCHAR2,
...
/
--------------------------------------------------------
--  DDL for Procedure ACTUALIZAR_TELEFONO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."ACTUALIZAR_TELEFONO" (
...
BEGIN
    ...
    --se anexa este bloque que indica una exepcion en caso no exista el cliente 
     IF SQL%ROWCOUNT = 0 THEN -- sql%rowcount verifica cuales filas fueron afectadas por la ultima instruccioin dada en caso sea igual a 0 entonces se indicara la alerta 
        RAISE_APPLICATION_ERROR(-20002, 'Cliente no encontrado.'); --raise application error nos ayuda a mostrar un mensaje en pantalla con un eror personalizado
    END IF;

EXCEPTION
    WHEN OTHERS THEN --captura cualquier error que halla sido manejado de forma especifica 
        RAISE_APPLICATION_ERROR(-20003, 'Error inesperado: ' || SQLERRM);
END;

/
--------------------------------------------------------
--  DDL for Procedure BUSCAR_PAGOS_CLIENTE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."BUSCAR_PAGOS_CLIENTE" (p_dui_cliente IN VARCHAR2) IS
    CURSOR c_pagos IS
...
/
--------------------------------------------------------
--  DDL for Procedure ELIMINAR_RESERVAS_ANTIGUAS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."ELIMINAR_RESERVAS_ANTIGUAS" (
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."REGISTRAR_RESERVA" ( --noneditionable esto me sirve para indicar que el procedimiento no cambiara a futuro por que es comun 
    p_num_reserva IN NUMBER, --estos son mis parametros de entrada 
    p_fecha_salida IN DATE,
    p_fecha_entrada IN DATE,
    p_dui_cliente IN VARCHAR2,
    p_num_habitacion IN NUMBER
) AS --inicio del cuerpo del procedimiento 
BEGIN --inicio del cuerpo logico
...
/
--------------------------------------------------------
--  DDL for Function CONTAR_RESERVAS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."CONTAR_RESERVAS" (p_dui_cliente VARCHAR2)
RETURN NUMBER IS
    cantidad NUMBER := 0;
BEGIN
    SELECT COUNT(*)
...
/
--------------------------------------------------------
--  DDL for Function TOTAL_PAGADO
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."TOTAL_PAGADO" (p_dui_cliente VARCHAR2)
RETURN NUMBER IS
    total NUMBER := 0;
BEGIN
    SELECT SUM(p.monto)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."AQ$_KEY_SHARD_MAP" MODIFY ("QUEUE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AQ$_KEY_SHARD_MAP" MODIFY ("KEY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AQ$_KEY_SHARD_MAP" MODIFY ("SHARD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AQ$_KEY_SHARD_MAP" MODIFY ("DELAY_SHARD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AQ$_KEY_SHARD_MAP" ADD CONSTRAINT "AQ$_KEY_SHARD_MAP_PK" UNIQUE ("QUEUE", "KEY")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CLIENTES" ADD PRIMARY KEY ("DUI")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."HABITACIONES" ADD PRIMARY KEY ("NUM_HABITACION")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."RESERVAS" ADD PRIMARY KEY ("NUM_RESERVA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PAGOS" ADD CONSTRAINT "FK_PAGO_RESERVA" FOREIGN KEY ("NUM_RESERVA")
	  REFERENCES "SYSTEM"."RESERVAS" ("NUM_RESERVA") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table RESERVAS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."RESERVAS" ADD CONSTRAINT "FK_RESERVA_CLIENTE" FOREIGN KEY ("DUI_CLIENTE")
	  REFERENCES "SYSTEM"."CLIENTES" ("DUI") ENABLE;
  ALTER TABLE "SYSTEM"."RESERVAS" ADD CONSTRAINT "FK_RESERVA_HABITACION" FOREIGN KEY ("NUM_HABITACION")
	  REFERENCES "SYSTEM"."HABITACIONES" ("NUM_HABITACION") ENABLE;
